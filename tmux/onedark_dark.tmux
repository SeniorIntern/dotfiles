...
# OneDark Pro color variables
bg=$(get_tmux_option "@minimal-tmux-bg" '#282c34')   # OneDark Pro background
fg=$(get_tmux_option "@minimal-tmux-fg" '#abb2bf')   # OneDark Pro foreground text
...
# OneDark Pro colors - current window highlight
tmux set-option -g window-status-current-format "#[fg=#61afef]$larrow#[bg=#61afef,fg=#282c34]${window_status_format}#{?window_zoomed_flag,${expanded_icon},}#[fg=#61afef,bg=default]$rarrow"
